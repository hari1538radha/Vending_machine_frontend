...
const Admin = () => {
  ...
  return (
    <div className=" flex font-poppins flex-col h-screen  justify-center items-center pt-28 pb-28 bg-gradient-to-b from-[#d5e9f7] via-green-200 to-[#edc6d5] sm:pt-10 sm:pb-10">
